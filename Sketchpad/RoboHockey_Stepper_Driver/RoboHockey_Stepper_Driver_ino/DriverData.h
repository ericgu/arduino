...
#define TICKS_PER_STEP 625

class DriverData
{
  public:
    AccelStepper* m_pStepper1;
    AccelStepper* m_pStepper2;
    
  DriverData()    
  {
    //m_pStepper1 = new AccelStepper(AccelStepper::FULL4WIRE, 6, 7, 8, 9);
    m_pStepper1 = new AccelStepper(AccelStepper::DRIVER, 8, 9);
    m_pStepper1->setSpeed(1200);
    m_pStepper1->setAcceleration(400);

    //m_pStepper2 = new AccelStepper(AccelStepper::FULL4WIRE, 10, 11, 12, 13);
    m_pStepper2 = new AccelStepper(AccelStepper::DRIVER, 12, 13);
    m_pStepper2->setSpeed(1200);
    m_pStepper2->setAcceleration(400);
  }
